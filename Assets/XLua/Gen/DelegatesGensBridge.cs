...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public int __Gen_Delegate_Imp0(int p0, out int p1, out int p2, out int p3)
		{
            ...
            lock (luaEnv.luaEnvLock)
            {
                ...
                p3 = LuaAPI.xlua_tointeger(L, errFunc + 4);
		...
		public int __Gen_Delegate_Imp1(int p0, ref int p1, ref int p2, ref int p3)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(LuaFunction3))
			{
			    return new LuaFunction3(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(LuaFunction3_1))
			{
			    return new LuaFunction3_1(__Gen_Delegate_Imp1);
			}
